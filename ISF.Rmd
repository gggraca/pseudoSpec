...
After loading the necessary packages, download the data file 'Lipid_Positive_QC.mzML' from [this location](https://github.com/gggraca/MetaboAnnotatoR/tree/master/inst/Data/) into the working directory.
